...
-------------------------------------------------------------------------------
--! platoboost library (все запросы через auth.platoboost.app)
-------------------------------------------------------------------------------
...
--! ============ ЕДИНЫЙ ХОСТ ============
-- Все запросы идут через auth.platoboost.app
local host = "https://auth.platoboost.app"
...
verifyBtn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        ...
        if ok and result == true then
            ...
            if not okLoad then
                warn("[Kneo] Ошибка загрузки main script: " .. tostring(loadErr))
                pcall(function()
                    game:GetService("StarterGui"):SetCore("SendNotification", {
